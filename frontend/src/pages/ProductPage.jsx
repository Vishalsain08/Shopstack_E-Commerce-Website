...
const ProductPage = () => {
  ...
  if (loading) return <p className="p-6 font-sans text-text">Loading product...</p>;
  if (!product) return <p className="p-6 font-sans text-danger">Product not found.</p>;

  return (
    <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-10 bg-background rounded-xl shadow-md font-sans">
      <img
        src={product.image}
        alt={product.name}
